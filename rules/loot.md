...
Ideas for loot. Some of these did make it into homebrew section on dndbeyond, but most of the ones listed here did not.

## Quick Ideas
- **Ring of Spell Splitting** - allows twinning on a spell that only targets one creature. Once per day.
- **Iridium Galvanizer** - Adds +1 to galvanised armor, OR +1 to galvanised weapons (via felgolos)

...
## Graycloaks
Militia of 400 archers and spearmen.
...
But they've spoken to the regiment leader; `Galeron` (who i inaccurately thought were the canonical leader, but that was a different elven greycloak faction, use different last name).
...
## Paths North
Giant Toll Troll Divinity 2.
Later tremors + cracks as they approach north (Yeenaghu).
